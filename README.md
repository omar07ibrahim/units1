...
The previously adopted set is retained only as rejected audit history while a
replacement is generated. Original-resolution review found that the 1440 px
capture clipped the selected “International mile (mi)” source label beneath
the native select affordance. Its hashes remain valid, but it must not be
treated as final portfolio evidence. The source fix and a new upload-first
review cycle are in progress.
